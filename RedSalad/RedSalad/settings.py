"""
Django settings for RedSalad project.
...
import os
from django.conf.global_settings import AUTHENTICATION_BACKENDS, STATIC_ROOT,\
    MEDIA_ROOT
...
SECRET_KEY = 'hh8vk+g7=5j4f!mjd1@xz(9y0-h@ik(7v__4^lziaf62%3_8-e'
...
WSGI_APPLICATION = 'RedSalad.wsgi.application'
